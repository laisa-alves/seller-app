  ...
  <div class="flex flex-col-reverse py-16 lg:pt-0 lg:flex-col lg:pb-0">
    ...
    >
      ...
      <img
        ...
        src="https://images.pexels.com/photos/6205492/pexels-photo-6205492.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"
        alt=""
      />
    </div>
    <div
    ...
    >
      <div class="mb-16 lg:my-40 lg:max-w-lg lg:pr-5">
        ...
        >
          Cadastre a sua loja e<br class="hidden md:block" />
          comece a vender no
          <br class="hidden lg:block" />
          <span class="inline-bloc">
            Deliver <span class="text-deep-orange-400 italic">me</span></span
          >
        </h2>
        ...
        <div class="flex items-center">
          ...
          <RouterLink
            :to="{ name: 'about' }"
            class="inline-flex items-center font-semibold text-gray-800 transition-colors duration-200 hover:text-deep-orange-400"
