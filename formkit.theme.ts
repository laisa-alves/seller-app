...
/**
  ...
  *
  * @checksum - ed7b87fe91b92ee6f7db7ad8659848b25762f224f0d6805df25c42792917e60a
  * @variables - radius=rounded-lg,accentColor=orange,colorTemperature=neutral,spacing=2.5,scale=base,inputShadow=shadow-sm,baseColorShade=500,borderShadeLightMode=300,borderShadeDarkMode=500,inputMaxWidth=max-w-[24em],tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
